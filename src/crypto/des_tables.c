...
/* ─── Original S-boxes ──────────────────────────────────────────────────── */
const uint8_t DES_SBOXES[8][4][16] = {
    /* S1 */
...
/* ─── Precomputed S-boxes (6-bit idx -> 4-bit value) ────────────────────── */
const uint8_t DES_SBOX_TABLES[8][64] = {
    /* generated with: row = ((idx&0x20)>>4)|(idx&1), col = (idx>>1)&0xF */
    /* S1 */
